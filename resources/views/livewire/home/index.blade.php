<div>
    ...
    <div id="default-carousel" class="absolute top-0 left-0 w-full h-screen z-0" data-carousel="slide">

        <!-- Carousel wrapper -->
        <div class="relative h-screen overflow-hidden"> <!-- Tinggi 90% dari viewport height (dinamis). -->
