<div>
    ...
    <div class="mb-8">
            ...
            <label for="card-toggle" class="absolute w-full h-full flex items-center justify-center text-white shadow-lg cursor-pointer z-10">
                ...
                <div class="absolute">
                    <div class="text-xl sm:text-2xl lg:text-3xl font-bold text-center">
                        Introduction to <span class="text-red-500">FiveCar</span>
                    </div>
        ...
        {{-- misi visi --}}
        <div class="flex flex-col md:flex-row justify-around mt-12 mx-8 py-8 rounded-lg shadow-lg bg-[#1a1a1a]">
            <div class="w-full md:w-[50%] text-center text-white">
            ...
            <div class="border-l border-red-500/50 my-4 mx-4 lg:my-0"></div>
        ...
        <div class="flex flex-wrap items-center pt-8 justify-center gap-2 lg:gap-12 mx-8">
            <div class="block flex justify-center p-6 rounded-lg text-center gap-4 bg-[#1a1a1a] w-full lg:w-[300px]"> 
                <i class="fas fa-shipping-fast text-base md:text-lg lg:text-xl text-red-500"></i> 
                <h5 class="text-sm md:text-base lg:text-lg font-bold tracking-tight text-red-500">Pengiriman Cepat</h5>
            </div>

            <div class="block flex justify-center p-6 rounded-lg text-center gap-4 bg-[#1a1a1a] w-full lg:w-[300px]"> 
                <i class="fas fa-tags text-base md:text-lg lg:text-xl text-red-500"></i> 
                <h5 class="text-sm md:text-base lg:text-lg font-bold tracking-tight text-red-500">Harga Kompetitif</h5>
            </div>

            <div class="block flex justify-center p-6 rounded-lg text-center gap-4 bg-[#1a1a1a] w-full lg:w-[300px]"> 
                <i class="fas fa-headset text-base md:text-lg lg:text-xl text-red-500"></i> 
                <h5 class="text-sm md:text-base lg:text-lg font-bold tracking-tight text-red-500">Dukungan Pelanggan 24/7</h5>
            </div>
        </div>
        ...
        <div class="text-center pt-8">
            <div class="text-xl sm:text-2xl lg:text-3xl font-bold text-center text-white">
                <span class="text-red-500">Team</span> Members
            </div>
            ...
            <div class="flex flex-wrap items-center justify-center pt-5 gap-2 lg:gap-8 mx-12 lg:mx-0">
                ...
                <div class="relative w-full sm:w-[250px] md:w-[250px] lg:w-[250px]">
                    ...
                    <div class="bg-white/80 rounded-lg shadow-lg px-4 py-2.5 mx-3 transform translate-y-[-50%]">
